...
class TitleBarButton(QPushButton):
    ...
    def __init__(self, style=None, parent=None):
        ...
        self.setMinimumSize(46, 32)
        self.setFixedSize(46,48)
...
class MaximizeButton(TitleBarButton):
    ...
    def paintEvent(self, e):
        ...
        if not self.__isMax:
            painter.drawRect(int(18*r), int(19*r), int(10*r), int(10*r))
        else:
            painter.drawRect(int(18*r), int(19*r), int(8*r), int(8*r))
            x0 = int(18*r)+int(2*r)
            y0 = 19*r
            dw = int(2*r)
